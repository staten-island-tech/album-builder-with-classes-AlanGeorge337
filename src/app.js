...
class UI {
    ...
    addAlbumToList(album){
        let html = `<div class="display-album flex-row"><div class="display-title">%title%</div>
        <div class="display-artist">%artist%</div><div class="display-cover">
        <img src=%url% alt=""></div>
        <div class="remove-album">Remove Album X</div> `;
...
document.getElementById("form").addEventListener("submit", function(e){
    ...
    //instantaite new album with values
